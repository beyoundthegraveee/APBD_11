...
namespace APBD11.Migrations
{
    ...
    [Migration("20240615203457_AddedDataToDatabase")]
            ...
            modelBuilder.Entity("APBD11.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPresctiprion = 1,
                            Date = new DateTime(2024, 6, 15, 22, 34, 57, 0, DateTimeKind.Local).AddTicks(1195),
                            DueDate = new DateTime(2024, 7, 15, 22, 34, 57, 0, DateTimeKind.Local).AddTicks(1238),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPresctiprion = 2,
                            Date = new DateTime(2024, 6, 15, 22, 34, 57, 0, DateTimeKind.Local).AddTicks(1242),
                            DueDate = new DateTime(2024, 7, 15, 22, 34, 57, 0, DateTimeKind.Local).AddTicks(1244),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
